...
- List 5-7 specific Sri Lankan foods that are beneficial
...
{f"Compare with previous scores {previous_scores} and explain if health is IMPROVING or DECLINING." if previous_scores else "This is the first report. Establish a baseline health score."}

HEALTH SCORE:
Give a single percentage (0-100%) based on current condition.
